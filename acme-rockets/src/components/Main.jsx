                ...
                <section id="testimonials" className="mb-10 scroll-mt-14 p-12">
                    ...
                    <figure className="my-12">
                        <blockquote className="relative rounded-3xl bg-white px-9 py-7 shadow-md dark:bg-gray-900 sm:px-11 sm:py-9">
                            <p className="text-left text-lg text-gray-600 transition-all before:absolute before:left-2 before:top-2 before:translate-x-0 before:translate-y-1 before:transform before:font-serif before:text-6xl before:text-white before:opacity-40 before:content-['\201C'] after:absolute after:-bottom-5 after:right-4 after:translate-x-2 after:translate-y-4 after:transform after:font-serif after:text-6xl after:text-white after:opacity-40 after:content-['\201D'] hover:text-gray-800 dark:text-slate-400 dark:hover:text-slate-300 sm:text-xl">
