    ...
    return (<>
        <div className={cls.main_head}>
            ...
            <div className={cls.font_size}>
                <label>
                    Font Size:
                    <input className={cls.font_size_input} type="number" min="1" max="40"
                        placeholder='font size...' value={fontSize}
                        onChange={e => { console.log(e.target.value); setFontSize(e.target.value) }} />
                </label>
            </div>
        ...
        <div className={cls.syntax_highlighter} ref={ref} style={{ fontSize: `${fontSize}px` }}>
